...
RUNCOMMAND_CONF="$RACONFIGDIR/runcommand.cfg"
VIDEO_CONF="$RACONFIGDIR/videomodes.cfg"
EMU_CONF="$RACONFIGDIR/emulators.cfg"
DISPMANX_CONF="$RACONFIGDIR/dispmanx.cfg"
RETRONETPLAY_CONF="$RACONFIGDIR/retronetplay.cfg"
