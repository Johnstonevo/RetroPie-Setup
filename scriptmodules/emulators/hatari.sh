...
function depends_hatari() {
    getDepends libsdl2-dev zlib1g-dev libpng-dev cmake libreadline-dev libjack-jackd2-dev portaudio19-dev
}
...
function configure_hatari() {
    ...
    addEmulator 0 "$md_id-fast" "atarist" "$md_inst/bin/hatari ${common_config[*]} --compatible 0 --timer-d 1 --borders 0 %ROM%"
