...
rp_module_help="ROM Extensions: .cdi .gdi\n\nCopy your Dreamcast roms to $romdir/dreamcast\n\nCopy the required BIOS files dc_boot.bin and dc_flash.bin to $biosdir/dreamcast"
...
function configure_reicast() {
    ...
    ln -sf "$biosdir/dreamcast/"{dc_boot.bin,dc_flash.bin} "$md_conf_root/dreamcast/data"
