...
function configure_lr-snes9x2010() {
  ...
  mkRomDir "snesh"
    ...
    addEmulator 1 "$md_id" "snesmsu1" "$md_inst/snes9x2010_libretro.so"
    addEmulator 1 "$md_id" "satellaview" "$md_inst/snes9x2010_libretro.so"
    ...
    if [ -e /usr/lib/libretro/snes9x2010_libretro.so ]
        then
          ...
          addEmulator 0 "$md_id-ppa" "snesmsu1" "$md_instppa/snes9x2010_libretro.so"
          addEmulator 0 "$md_id-ppa" "satellaview" "$md_instppa/snes9x2010_libretro.so"
