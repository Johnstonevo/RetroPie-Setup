...
function configure_lr-snes9x2005() {
  ...
  mkRomDir "snesh"
    ...
    addEmulator 0 "$md_id" "snescd" "$md_inst/snes9x2005_libretro.so"
    addEmulator 0 "$md_id" "nintendobsx" "$md_inst/snes9x2005_libretro.so"
    ...
    addSystem "sufami"
    if [ -e /usr/lib/libretro/snes9x2005_libretro.so ]
        then
          ...
          addEmulator 0 "$md_id-ppa" "snescd" "$md_instppa/snes9x2005_libretro.so"
          addEmulator 0 "$md_id-ppa" "nintendobsx" "$md_instppa/snes9x2005_libretro.so"
